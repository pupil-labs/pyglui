...
cdef class Slider(UI_element):
    ...
    def __cinit__(self,basestring attribute_name, object attribute_context = None,label = None, min = 0, max = 100, step = 0,setter= None,getter= None):
        self.uid = id(self)
        self.label = unicode(label or attribute_name)
        self.sync_val = Synced_Value(unicode(attribute_name),attribute_context,getter,setter)
        self.step = abs(step)
        self.minimum = min
        if self.step:
    ...
    def __init__(self,basestring attribute_name, object attribute_context = None,label = None, min = 0, max = 100, step = 1,setter= None,getter= None):
        self.sync()
    ...
    cpdef draw(self,FitBox parent,bint nested=True, bint parent_read_only = False):
        ...
        if type(self.sync_val.value) == float:
            glfont.draw_text(self.field.size.x-x_spacer,0,unicode(self.display_format%self.sync_val.value) )
            glfont.pop_state()
            used_x = glfont.text_bounds(0,0,unicode(self.display_format%self.sync_val.value))
        else:
            glfont.draw_text(self.field.size.x-x_spacer,0,unicode(self.sync_val.value ))
            glfont.pop_state()
            used_x = glfont.text_bounds(0,0,unicode(self.sync_val.value))
...
cdef class Switch(UI_element):
    ...
    def __cinit__(self,basestring attribute_name, object attribute_context = None, on_val=True, off_val=False, label=None, setter=None, getter=None):
        self.uid = id(self)
        self.label = unicode(label or attribute_name)
        self.sync_val = Synced_Value(unicode(attribute_name),attribute_context,getter,setter)
        self.on_val = on_val
    ...
    def __init__(self,basestring attribute_name, object attribute_context = None,label = None, on_val = True, off_val = False ,setter= None,getter= None):
        pass
...
cdef class Selector(UI_element):
    ...
    def __cinit__(self,basestring attribute_name, object attribute_context = None, selection = [], labels=None, label=None, setter=None, getter=None, selection_getter = None):
        self.uid = id(self)
        self.label = unicode(label or attribute_name)
        ...
        def default_selection_getter():
            return selection,(labels or [unicode(s) for s in selection])
        ...
        self.sync_val = Synced_Value(unicode(attribute_name),attribute_context,getter,setter,self._on_change)
    ...
    def _on_change(self,new_value):
        ...
        try:
            ...
            #self.selection_labels.append(unicode(new_value))
            raise ValueError("Synced value '%s' is not part of selection."%unicode(new_value))
...
cdef class Text_Input(UI_element):
    ...
    cdef double t0
    def __cinit__(self,basestring attribute_name, object attribute_context = None,label = None,setter= None,getter= None):
        self.uid = id(self)
        self.label = unicode(label or attribute_name)
        self.sync_val = Synced_Value(unicode(attribute_name),attribute_context,getter,setter)
        ...
        self.preview = unicode('') #only used when self.selected==True
    ...
    def __init__(self,basestring attribute_name, object attribute_context = None,label = None,setter= None,getter= None):
        pass
            ...
            for b in new_input.buttons[:]:
                if b[1] == 1 and visible:
                    if self.textfield.mouse_over(new_input.m):
                        ...
                        self.selected = True
                        self.highlight = False
                        self.preview = unicode(self.sync_val.value)
                        self.caret = len(self.preview)
    ...
    cdef draw_text_field(self):
        cdef float x
        cdef unicode highlight_size = <unicode>''
        ...
        if self.selected:
            ...
            gl.glTranslatef(self.textfield.org.x,self.textfield.org.y,0)
            glfont.draw_limited_text(x_spacer,0,unicode(self.sync_val.value),self.textfield.size.x-x_spacer)
            gl.glPopMatrix()
...
cdef class Info_Text(UI_element):
    ...
    property text:
        ...
        def __set__(self,unicode new_text):
            global should_redraw
...
cdef class Thumb(UI_element):
    ...
    cdef unicode label_font
    cdef Synced_Value sync_val
    cdef public RGBA on_color,off_color
    cdef unicode _status_text
    cdef object hotkey

    def __cinit__(self,basestring attribute_name, object attribute_context = None, on_val=True, off_val=False, label=None,label_font='roboto', label_offset_x=0, label_offset_y=0,label_offset_size=0, setter=None, getter=None, hotkey = None,  on_color=thumb_color_on, off_color=thumb_color_off):
        self.uid = id(self)
        self.label = unicode(label or attribute_name)[0]
        self.label_font = unicode(label_font)
        ...
        self.hotkey = hotkey
        self._status_text = unicode('')

    def __init__(self,basestring attribute_name, object attribute_context = None, on_val=True, off_val=False, label=None,label_font='roboto', label_offset_x=0, label_offset_y=0,label_offset_size=0, setter=None, getter=None, hotkey = None,  on_color=thumb_color_on, off_color=thumb_color_off):
        pass
    ...
    property status_text:
        ...
        def __set__(self,unicode new_status_text):
...
cdef class Hot_Key(UI_element):
    ...
    def __cinit__(self,basestring attribute_name, object attribute_context = None, on_val=True, off_val=False, label=None, setter=None, getter=None, hotkey = None):
        self.uid = id(self)
        self.label = unicode(label or attribute_name)
        self.sync_val = Synced_Value(unicode(attribute_name),attribute_context,getter,setter)
        self.on_val = on_val
    ...
    def __init__(self,basestring attribute_name, object attribute_context = None,label = None, on_val = True, off_val = False ,setter= None,getter= None, hotkey = None):
        pass
